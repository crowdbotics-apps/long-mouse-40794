"""
Django settings for long_mouse_40794 project.
...
ROOT_URLCONF = 'long_mouse_40794.urls'
...
WSGI_APPLICATION = 'long_mouse_40794.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_mouse_40794 API",
    "DESCRIPTION": "API documentation for long_mouse_40794 App",
    "VERSION": "v1",
}
